...
export default function SignUpForm({
  ...
  const iconPassword = showPassword ? (
    <svg
      ...
      strokeWidth={1.5}
      stroke='#F2F2F2'
      className='w-5 h-5   xl:w-7 xl:h7'
    >
      <path
        strokeLinecap='round'
  ...
  return (
    <main className='Login pt-16 w-full h-auto min-h-screen flex flex-col items-center justify-start   xl:pt-32'>
      <h2 className='FontSemibold my-6 w-[280px] text-[#D5BAFE] text-3xl text-left   lg:w-[400px] lg:text-5xl   xl:my-10 xl:text-7xl xl:w-[700px]'>
        Sign up
      </h2>
      <form
        onSubmit={handleSubmit}
        className='w-[280px] flex flex-col items-center justify-center   lg:w-[400px] xl:w-[700px]'
      >
        <input
        ...
        <div className='w-full flex items-center relative'>
          ...
          <button
            ...
            type='button'
            onClick={() =>
              setShowPassword(showPassword ? false : !showPassword)
            }
          >
            {iconPassword}
          </button>
        ...
        >
          ...
          <svg
            ...
            strokeWidth={2}
            stroke='#1D1C21'
            className='w-4 h-4   xl:w-7 xl:h7'
          >
            <path
              strokeLinecap='round'
              strokeLinejoin='round'
